...
| Nonverbal cues to deception are weak/unreliable (meta-analysis of behavioral cues) — **limits our own Theme-4 claim** | DePaulo, Lindsay, Malone, Muhlenbruck, Charlton & Cooper, *Psychological Bulletin* 129(1), 74–118 (2003) | https://doi.org/10.1037/0033-2909.129.1.74 | ⚠️ AI-checked 2026-07-19 via Crossref: paper confirmed. **Correction: the 54% accuracy figure belongs to the paper below, not this one** |
| Human lie-truth judgment accuracy averages 54% (206 documents, 24,483 judges) | Bond & DePaulo, *Personality and Social Psychology Review* 10(3), 214–234 (2006) | https://doi.org/10.1207/s15327957pspr1003_2 | ⚠️ AI-checked 2026-07-19 via Crossref: title/authors/54%/24,483 judges confirmed |
