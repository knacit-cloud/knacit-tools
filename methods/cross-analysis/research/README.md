...
| ~~"Machine errors judged more harshly than human errors"~~ **DUPLICATE RESOLVED 2026-07-25**: `fpsyg.2022.779028` and `PMC9177159` are confirmed the *same* Maasland & Weißmüller paper (merged into the row above). The "machine errors judged more harshly" wording was **mis-attributed** — it is not this paper's finding and has **no source of its own yet**; drop it or find a real primary before use | — | — | ❌ removed (no valid source) |
