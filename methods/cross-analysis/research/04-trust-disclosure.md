...
| # | 主張の核 | 一次リンク | 状態 |
|---|---|---|---|
| A | コンピュータと信じると評価恐怖↓・開示↑（本拠） | https://www.sciencedirect.com/science/article/abs/pii/S0747563214002647 ／**無料全文＝著者研究室(CMU MultiComp): http://multicomp.cs.cmu.edu/its-only-a-computer-virtual-humans-increase-willingness-to-disclose/** （Lucas, Gratch, King & Morency, CHB 37:94-100, 2014, doi:10.1016/j.chb.2014.04.043） | ⚠️（2026-07-19照合：Semantic Scholarで書誌・要旨確認。被引用849。開示恐怖↓・印象管理↓・悲しみ表出↑を確認。**2026-07-25：SDはペイウォールだがCMU研究室に無料全文あり→人間確認が容易に**） |
