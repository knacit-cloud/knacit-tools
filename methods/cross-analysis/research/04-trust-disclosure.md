...
| H | チャットボットの会話型調査はWeb調査よりエンゲージ・回答品質（情報量/関連/具体/明瞭）が有意に高い（実地N≈600）＝**人間側"深さ"主張への反証** | https://dl.acm.org/doi/10.1145/3381804 （Xiao, Zhou, Liao, Mark, Chi, Chen, Yang, "Tell Me About Yourself: Using an AI-Powered Chatbot to Conduct Conversational Surveys", ACM TOCHI 27(3), 2020） | ⚠️AI要旨確認・人間確認待ち（2026-07-20：Gricean Maximsで機械優位を要旨確認。被引用171。DOI 10.1145/3381804はCrossrefで要最終確認） |
