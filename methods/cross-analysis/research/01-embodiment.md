...
**Verification note:** Per-row state is tagged `［depth｜claim-support｜human-check］` — see the [legend](README.md#状態ラベルの読み方2026-07-27-導入). **Human verification is now underway (2026-07-27): A, C and D are ✅.** D turned out to be open access — the earlier "paywalled" note was likely a bot-block misread as a paywall (same pattern as the Lucas 2014 dead-link mixup). Everything else here is still ⚠️: open the primary link before publishing. Rule: [the-fabricated-citation.md](../the-fabricated-citation.md).
